...
const Cases = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      {/* Hero Header with Emotional Message */}
      <header className="bg-gradient-to-r from-red-600 to-orange-600 dark:from-red-700 dark:to-orange-700 shadow-2xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/95 text-base md:text-lg font-medium max-w-2xl">
                Every person matters. Every case deserves attention. Together, we bring them home.
              </p>
            </div>
            <Link
              to="/report"
