...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-whiten mt-24 dark:from-black dark:via-orange-950/20 dark:to-black dark:bg-gradient-to-b flex items-center justify-center p-4">
      <motion.div
